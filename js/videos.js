  ...
  items.forEach((item) => {
    ...
    >
      <img
        ...
        alt=""
      />
      <p class="detalhe-video" data-link="${item.link}" onclick="openMovie(this)">
        <svg
...
function showDetail(element) {
  element.classList.add("detalhe-hover");
  element.children[1].style.display = "block";
}

function closeDetail(element) {
  element.classList.remove("detalhe-hover");
